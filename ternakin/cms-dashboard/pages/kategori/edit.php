  ...
  // Query
    $id = $_GET['id'];
    $kategori = mysqli_query($con , "SELECT * FROM tb_produk_jenis WHERE id_jenis_produk='".$id."'") or die(mysqli_error($con));
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <form method="POST" action="aksi" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?=$data_kategori['id_jenis_produk']?>">
                    <div class="form-group">
                      <label>Nama</label>
                      <input type="text" name="nama" class="form-control" maxlength="35" value="<?=$data_kategori['nama_jenis_produk']?>">
                    </div>
                    <div class="form-group">
                      <label>Icon</label>
                    ...
                    <div id="preview-img">
                    <button type="submit" class="btn btn-primary form-control" name="aksi" value="edit">Edit</button>
                  </form>
                </div>
              </div>
