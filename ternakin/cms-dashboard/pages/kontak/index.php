              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                      <table class="table table-bordered" id="listkontak" width="100%" cellspacing="0">
                        <thead>
                          <tr>
                            <th>No.</th>
                            <th>Nama.</th>
                            ...
                            while ($data = mysqli_fetch_array($sql)) {
                              ?>
                                <tr>
                                  <td><?=$no++?></td>
                                  <td><?=$data['nama']?></td>
                                  <td><img src="<?=$_ENV['base_url']?>/assets/image/kontak/<?php echo $data['icon'] ?>" class="img-fluid fas fa-fw"></td>
                                  <td class="text-center">
                                    <div class="d-flex">
                                      <a href="edit.php?id_kontak=<?php echo $data['id_kontak']; ?>" class="btn btn-primary mr-1"><i class="fas fa-pencil-alt"></i></a> 
                                      <form method="POST" action="aksi">
                                        <button type="submit" class="btn btn-danger" name="aksi" value="hapus-kontak" onclick="return confirm('Yakin akan dihapus?')">
